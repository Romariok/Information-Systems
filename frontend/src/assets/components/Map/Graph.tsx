...
import { appSelector, IMovie, setUpdatedMovie } from "../../../storage/Slices/AppSlice";
import { AppDispatch } from '../../../storage/store';
import { MovieArray } from '../Movie/MovieTable';
import MovieInfo from './MovieInfo';



export default function Graph({ points, movies }: { points: number[][], movies: MovieArray }) {
    ...
    return (
        <div className="graph" >
            ...
            <div><MovieInfo open={open} onClose={handleClose} /></div>
