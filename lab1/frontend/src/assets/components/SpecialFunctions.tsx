...
export default function CoordinatesTable() {
   ...
   const handleGetDirectorCount = async () => {
      ...
      try {
         const link = "http://localhost:8080/movie/count/director";
   ...
   const handleGetMoviesNoOscars = async () => {
      ...
      dispatch(setFetching(true));
      try {
         const link = "http://localhost:8080/movie/no-oscars";
   ...
   const handleGetLessUsaBoxOffice = async () => {
      ...
      try {
         ...
         const link = `http://localhost:8080/movie/usa-box-office/less/${usaLessCount}`;
   ...
   const handleGetTaglineSubstring = async () => {
      ...
      dispatch(setFetching(true));
      try {
         const link = `http://localhost:8080/movie/tagline/${taglineSubstring}`;
   ...
   const handleRemoveMoviesByGenre = async () => {
      ...
      try {
         ...
         const link = "http://localhost:8080/movie/remove-oscars";
         let headers = {
         ...
         const response = await axios.post(link,{}, {params: {genre: removeOscarsGenre},
            headers: headers
         });
         const data = response.data;
         if (response.status === 200) {
