...
import { appSelector, clearState, sendUpdatedMovie } from "../../../storage/Slices/AppSlice";
import { useDispatch, useSelector } from 'react-redux';
import { IUpdateMovie } from "../../../storage/Slices/AppSlice";
...
const LocationForm: React.FC<CoordinateFormProps> = ({ open, onClose }) => {
   ...
   const { isFetching, isSuccess, isError, errorMessage, persons, coordinates, movie } = useSelector(appSelector);
   ...
   const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      dispatch(sendUpdatedMovie(newData as IUpdateMovie));
   };
   ...
   }, [isError, isSuccess, dispatch, movie]);
