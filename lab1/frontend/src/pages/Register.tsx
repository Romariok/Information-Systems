...
import { signupUser, signupSelector, clearState } from '../storage/Slices/RegisterSlice';
      ...
      >
        ...
        <Box>
          <Box component="form" noValidate sx={{
            ...
            <img src="/public/undertale-red.svg" style={{ width: '50px', height: '80px' }} alt="Undertale Red" />
            <TextField
              margin="normal"
              required
              fullWidth
            ...
            <Link href="/user/signIn" variant="body1" sx={{ fontFamily: "Undertale", color: 'orange' }}>
